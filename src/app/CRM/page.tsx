    ...
    <div className="flex flex-col gap-8 p-4 md:p-8">
      ...
      <header className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-base">Visualize e gerencie o funil de vendas em formato Kanban.</p>
        </div>
      </header>
      {/* Kanban Board */}
          ...
          <div className="flex-1 bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 min-w-[220px] flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="bg-white dark:bg-slate-900 border border-blue-100 dark:border-blue-700 rounded-lg p-3 shadow-sm">
                <div className="font-medium text-blue-800 dark:text-blue-200">João Silva</div>
                <div className="text-xs text-slate-500 dark:text-slate-400">Solicitou contato - 10/06</div>
              </div>
              <div className="bg-white dark:bg-slate-900 border border-blue-100 dark:border-blue-700 rounded-lg p-3 shadow-sm">
                <div className="font-medium text-blue-800 dark:text-blue-200">Maria Souza</div>
          ...
          <div className="flex-1 bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 min-w-[220px] flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-white dark:bg-slate-900 border border-indigo-100 dark:border-indigo-700 rounded-lg p-3 shadow-sm">
                <div className="font-medium text-indigo-800 dark:text-indigo-200">Carlos Lima</div>
          ...
          <div className="flex-1 bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 min-w-[220px] flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-700 rounded-lg p-3 shadow-sm">
                <div className="font-medium text-emerald-800 dark:text-emerald-200">Ana Paula</div>
          ...
          <div className="flex-1 bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 min-w-[220px] flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-white dark:bg-slate-900 border border-rose-100 dark:border-rose-700 rounded-lg p-3 shadow-sm">
                <div className="font-medium text-rose-800 dark:text-rose-200">Pedro Henrique</div>
